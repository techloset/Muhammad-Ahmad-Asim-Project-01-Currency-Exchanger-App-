...
export default function CurrencyCard() {
  return (
    <div className="rounded-md bg-white shadow-2xl p-4 w-2/3 mx-auto">
      <h1 className="text-center font-roboto text-2xl font-bold leading-7 text-gray-800 mt-6 mb-8">
